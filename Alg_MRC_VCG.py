...
def Mechanism_Core_Quad_VCG(bid_information, bid_prices, bid_items, dummy_bids, Winners, Welfare):
    ...
    my_obj = [("u" + str(win_bids[i]), - VCG_utility[i]) for i in range(winner_num)]
